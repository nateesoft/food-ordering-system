...
const convertApiMenuItem = (apiItem: ApiMenuItem): MenuItem => {
  ...
  return {
    ...
    availableAddOns: apiItem.availableAddOns?.map((a: any) => ({
      id: a.addOn.id,
      name: a.addOn.name,
      price: a.addOn.price,
      category: a.addOn.category,
    })) || [],
    availableAddOnGroups: apiItem.availableAddOnGroups?.map((g: any) => ({
      id: g.addOnGroup.id,
      name: g.addOnGroup.name,
      description: g.addOnGroup.description,
      price: g.addOnGroup.price,
      category: g.addOnGroup.category,
      image: g.addOnGroup.image,
      addOnIds: g.addOnGroup.items?.map((i: any) => i.addOnId) || [],
      addOns: g.addOnGroup.items?.map((i: any) => ({
        id: i.addOn.id,
        name: i.addOn.name,
        price: i.addOn.price,
        category: i.addOn.category,
      })) || [],
    })) || [],
    nestedMenuConfig,
